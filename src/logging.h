...
public:
  ...
  virtual void debug_log(const char *function_name, const char *message) const = 0;
  virtual void debug_log(const char *function_name, const std::string &message) const = 0;
  virtual void debug_log_alloca(const char *function_name, const char *variable_name,
                        size_t length) const = 0;

  virtual void debug_log_new(const char *function_name, const char *variable_name,
                     size_t length) const = 0;

  virtual void error_log(const char *function_name, const char *message) const = 0;
  virtual void error_log(const char *function_name, const std::string &message) const = 0;
  [[noreturn]] virtual void log_error_and_throw(const char *function_name,
